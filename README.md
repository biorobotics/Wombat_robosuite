1. This "version_3" branch has the iPhone 12 pro max in the simulation, added through wombat_arm.xml, + most updated model of "D3_gripper" i.e. it has 4-DoF whereas the earlier model had only 2-DoF
