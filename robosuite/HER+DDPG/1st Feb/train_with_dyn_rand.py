...
class D3_pick_place_env(object):
	...
	def set_env(self,phone_x,phone_speed,phone_orient):
		...
		# print(BoxObject(name="box",size=[0.35,9.7,0.37],rgba=[0.5,0.5,0.5,1],friction=[1,1,1]))
		self.box.set('pos', '0.6 -2 0')
		self.world.worldbody.append(self.box)
		# print(self.world)

		# self.iPhone_collision = CanObject(MujocoXMLObject("/home/yashraghav/robosuite/robosuite/models/assets/objects/can.xml",name="CanObject"))
		# self.iPhone_visual = CanVisualObject(MujocoXMLObject("/home/yashraghav/robosuite/robosuite/models/assets/objects/can-visual.xml",name="CanVisualObject"))
		# # print("coll",self.iPhone_collision)
		# # print("vis",self.iPhone_visual)
		...
		# 		(CanVisualObject, iPhone12ProMaxVisualObject),
		# 		self.obj_names,
		# ):
		...
		# 		(CanObject, iPhone12ProMaxObject),
		# 		self.obj_names,
		# ):
		...
		# # 	mujoco_robots=self.mujoco_robot, 
		# # 	mujoco_objects=self.visual_objects + self.objects,
		# # )

		# ##ends here
		# self.mujoco_objects = self.visual_objects + self.objects 
	...
	def step(self,action):
		...
		# if self.is_render:
		# 	# pass
		# 	# self.viewer1.cam.lookat[1]+=0.0008
		# 	self.viewer1.render()
		# print("sending steps")
		self.observation_current = self.get_observation()
