				...
				for r_mpi in range(self.args.num_rollouts_per_mpi):
					...
					for t in range(self.env_params['max_timesteps']):
						...
						### Start snatch motion ###
							...
							# print(action_zero)
							# print("obs[21]",obs_current[21])
							# print("obs[26]",obs_current[26])
							# print("obs[27]",obs_current[27])
							...
							print("obs_current[27]:", obs_current[27])
							...
							# print(action_zero[2])
							if np.linalg.norm(obs_current[21]-0.875)<0.001 and pp == 1 and obs_current[26]< 0.01:
								# print("stay!!")
								action_zero[2] = pos_z
								action_zero[6] = 0.4
								action_zero[7] = 0.4
							...
							elif obs_current[26]> 0.01 and action_zero[2]>0.55:
