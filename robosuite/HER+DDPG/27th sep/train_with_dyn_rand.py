...
class D3_pick_place_env(object):
	...
	def set_env(self,phone_x,phone_speed,phone_orient):
		...
		self.iphonebox = BoxObject(name="iphonebox",size=[0.045,0.08,0.0072],rgba=[0,0,0,1],friction=[1,1,5]).get_obj()
	...
	def grip_signal(self,des_state,obs_last,obs_last2last):
		if des_state=='open':
			left_finger_open = 0#-0.287884
			right_finger_open = 0#-0.295456
		...
		if des_state=='close':
			left_finger_close = 0.246598+0.3
			right_finger_close = 0.241764+0.3
	...
	def clip_grip_action(self):
		...
		if self.sim.data.get_joint_qpos('robot0_gripper_left_finger_joint')>=0.26:
			self.sim.data.set_joint_qpos('robot0_gripper_left_finger_joint', 0.30)
		if self.sim.data.get_joint_qpos('robot0_gripper_right_finger_joint')>=0.26:
			self.sim.data.set_joint_qpos('robot0_gripper_right_finger_joint', 0.30)
		# if self.sim.data.get_joint_qpos('robot0_gripper_left_finger_joint')<=0:
		# 	self.sim.data.set_joint_qpos('robot0_gripper_left_finger_joint', 0)
		# if self.sim.data.get_joint_qpos('robot0_gripper_right_finger_joint')<=0:
		# 	self.sim.data.set_joint_qpos('robot0_gripper_right_finger_joint', 0)
