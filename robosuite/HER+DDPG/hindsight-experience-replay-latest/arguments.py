...
def get_args():
    ...
    parser.add_argument('--demo-length', type=int, default=25, help='the demo length')
    ...
    parser.add_argument('--env-name', type=str, default='PickPlaceiPhone', help='name of environment')
    ...
    parser.add_argument('--offscreen_camera', type=str, default='frontview', help='rcamera used for offline rendering')
