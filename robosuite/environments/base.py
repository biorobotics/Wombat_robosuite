...
class MujocoEnv(metaclass=EnvMeta):
	...
	def __init__(
		...
		# print("init() base.py in environments")
		# Rendering-specific attributes
		self.has_renderer = has_renderer
		#print("base.py in environments")
	...
	def initialize_time(self, control_freq):
		...
		"""
		# print("initialize_time() base.py in environments")
		self.cur_time = 0
	...
	def set_model_postprocessor(self, postprocessor):
		...
		Args:
			postprocessor (None or function): If set, postprocessing method should take in a Task-based instance and
				return no arguments.
		"""
		# print("set_model_postprocessor() base.py in environments")
		self._model_postprocessor = postprocessor

	def _load_model(self):
		"""Loads an xml model, puts it in self.model"""
		# print("_load_model() base.py in environments")
		pass
	...
	def _postprocess_model(self):
		...
		"""
		# print("_postprocess_model() base.py in environments")
	...
	def _setup_references(self):
		...
		"""
		# print("_setup_references() base.py in environments")
		pass
	...
	def _setup_observables(self):
		...
		"""
		# print("_setup_observables() base.py in environments")
		return OrderedDict()
	...
	def _initialize_sim(self, xml_string=None):
		...
		#print(xml_string)
		#print(self.model.get_model(mode="mujoco_py"))
		#print("hello")
		# print("_initialize_sim() base.py in environments")
	...
	def reset(self):
		...
		# print("reset() base.py in environments")
	...
	def _reset_internal(self):
		...
		# print("_reset_internal() base.py in environments")
	...
	def _update_observables(self, force=False):
		...
		"""
		# print("_update_observables() base.py in environments")
		for observable in self._observables.values():
	...
	def _get_observations(self, force_update=False):
		...
		"""
		# print("_get_observations() base.py in environments")
	...
	def step(self, action):
		...
		"""
		# print("step() base.py in environments")
		if self.done:
		...
		# print("action in base.py environment", action)
		for i in range(int(self.control_timestep / self.model_timestep)):
			#print("branch1_joint position before sim.forward in base.py",self.sim.data.get_joint_qpos("robot0_branch1_joint"))
			self.sim.forward()
			#print("branch1_joint position after sim.forward in base.py",self.sim.data.get_joint_qpos("robot0_branch1_joint"))
			self._pre_action(action, policy_step)
			#print("branch1_joint position after ._pre_action in base.py",self.sim.data.get_joint_qpos("robot0_branch1_joint"))
			self.sim.step()
			#print("branch1_joint position after sim.step in base.py",self.sim.data.get_joint_qpos("robot0_branch1_joint"))
	...
	def _pre_action(self, action, policy_step=False):
		...
		"""
		# print("_pre_action() base.py in environments")
		self.sim.data.ctrl[:] = action*20
		# print("self.sim.data.ctrl[:] in base.py",self.sim.data.ctrl[:])
	...
	def _post_action(self, action):
		...
		"""
		# print("_post_action() base.py in environments")
	...
	def reward(self, action):
		...
		"""
		# print("reward() base.py in environments")
	...
	def render(self):
		...
		"""
		#print("render() base.py in environments")
		self.viewer.render()
	...
	def observation_spec(self):
		...
		Returns:
			OrderedDict: Observations from the environment
		"""
		# print("observation_spec() base.py in environments")
	...
	def clear_objects(self, object_names):
		...
		"""
		# print("clear_objects() base.py in environments")
	...
	def visualize(self, vis_settings):
		...
		# print("visualize() base.py in environments")
		for obj in self.model.mujoco_objects:
	...
	def reset_from_xml_string(self, xml_string):
		...
		# print("reset_from_xml_string() base.py in environments")
		self.close()
	...
	def check_contact(self, geoms_1, geoms_2=None):
		...
		# print("check_contact() base.py in environments")
	...
	def get_contacts(self, model):
		...
		# print("get_contacts() base.py in environments")
	...
	def add_observable(self, observable):
		...
		"""
		# print("add_observable() base.py in environments")
	...
	def modify_observable(self, observable_name, attribute, modifier):
		...
		"""
		# Find the observable
		# print("modify_observable() base.py in environments")
	...
	def _check_success(self):
		...
		"""
		# print("_check_success() base.py in environments")
		raise NotImplementedError
	...
	def _destroy_viewer(self):
		...
		"""
		# if there is an active viewer window, destroy it
		# print("_destroy_viewer() base.py in environments")
	...
	def close(self):
		...
		# print("close() base.py in environments")
		self._destroy_viewer()
	...
	def observation_modalities(self):
		...
		"""
		# print("observation_modalities() base.py in environments")
	...
	def observation_names(self):
		...
		"""
		# print("observation_names() base.py in environments")
	...
	def enabled_observables(self):
		...
		"""
		# print("enabled_observables() base.py in environments")
	...
	def active_observables(self):
		...
		"""
		# print("active_observables() base.py in environments")
	...
	def _visualizations(self):
		...
		"""
		# print("_visualizations() base.py in environments")
		return {"env"}
	...
	def action_spec(self):
		...
		"""
		# print("action_spec() base.py in environments")
		raise NotImplementedError
	...
	def action_dim(self):
		...
		"""
		# print("action_dim() base.py in environments")
		raise NotImplementedError
