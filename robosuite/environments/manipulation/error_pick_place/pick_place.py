...
class PickPlace(SingleArmEnv):
	...
	def reward(self, action=None):
		...
		print("self.t", self.t)
		self.t = self.t + 1
		# global bin_x_half, bin_y_half
		# bin_x_half = 0
		# bin_y_half = -1.5
		self.placement_initialize(self.t)
	...
	def _get_placement_initializer(self):
		...
		"""
		print("_get_placement_initializer")
		...
		# print("bin_x_half", bin_x_half)
		# print("bin_y_half", bin_y_half)
		# print("self.objects", self.objects)
	...
	def placement_initialize(self, t):
		"""
		Helper function for defining placement initializer at every time step and object sampling bounds.
		"""
		# fixtures = {'Milk': ((0.1, -1.75, 0.885), array([-0.35263655, 0, 0, 0.93576037]), <robosuite.models.objects.xml_objects.MilkObject object at 0x7f5dea6dcba8>), 'Bread': ((0.1, -1.75, 0.8450000000000001), array([0.64478112, 0, 0, 0.76436726]), <robosuite.models.objects.xml_objects.BreadObject object at 0x7f5dea6e1cc0>), 'Cereal': ((0.1, -1.75, 0.9), array([-0.41672785, 0, 0, 0.9090313]), <robosuite.models.objects.xml_objects.CerealObject object at 0x7f5dea6e68d0>), 'Can': ((0.1, -1.75, 0.8600000000000001), array([0.02783681, 0, 0, 0.99961248]), <robosuite.models.objects.xml_objects.CanObject object at 0x7f5dea6e6c88>), 'iPhone12ProMax': ((0.1, -1.75, 0.8600000000000001), array([-0.8474171, 0, 0, 0.53092773]), <robosuite.models.objects.xml_objects.iPhone12ProMaxObject object at 0x7f5dea6ec7f0>)}
		# fixtures = {'Milk': ((0.1, -1.75, 0.885), array([-0.52373736,  0.        ,  0.        ,  0.85187979]), <robosuite.models.objects.xml_objects.MilkObject object at 0x7f707405bb70>), 'Bread': ((0.1, -1.75, 0.8450000000000001), array([0.89972842, 0.        , 0.        , 0.4364502 ]), <robosuite.models.objects.xml_objects.BreadObject object at 0x7f707405fc88>), 'Cereal': ((0.1, -1.75, 0.9), array([-0.5229968 ,  0.        ,  0.        ,  0.85233464]), <robosuite.models.objects.xml_objects.CerealObject object at 0x7f7074065898>), 'Can': ((0.1, -1.75, 0.8600000000000001), array([-0.57504808,  0.        ,  0.        ,  0.81811962]), <robosuite.models.objects.xml_objects.CanObject object at 0x7f7074065c50>), 'iPhone12ProMax': ((0.1, -1.75, 0.8600000000000001), array([-0.5948267 ,  0.        ,  0.        ,  0.80385397]), <robosuite.models.objects.xml_objects.iPhone12ProMaxObject object at 0x7f707406b7b8>), 'VisualMilk': ((0.0025000000000000022, 0.15750000000000003, 0.885), array([1., 0., 0., 0.]), <robosuite.models.objects.xml_objects.MilkVisualObject object at 0x7f70740c29e8>), 'VisualBread': ((0.1975, 0.15750000000000003, 0.8450000000000001), array([1., 0., 0., 0.]), <robosuite.models.objects.xml_objects.BreadVisualObject object at 0x7f70740cac88>), 'VisualCereal': ((0.0025000000000000022, 0.4025000000000001, 0.9), array([1., 0., 0., 0.]), <robosuite.models.objects.xml_objects.CerealVisualObject object at 0x7f70740d2588>), 'VisualCan': ((0.1975, 0.4025000000000001, 0.8600000000000001), array([1., 0., 0., 0.]), <robosuite.models.objects.xml_objects.CanVisualObject object at 0x7f70740d2e10>)}
		# ipdb.set_trace()
		fixtures = {'Milk': ((0.1, -1.75, 0.885), np.array([-0.2499953 ,  0.        ,  0.        ,  0.96824705]), MilkObject), 'Bread': ((0.1, -1.75, 0.8450000000000001), np.array([0.48160994, 0.        , 0.        , 0.87638568]), BreadObject), 'Cereal': ((0.1, -1.75, 0.9), np.array([0.99627175, 0.        , 0.        , 0.08627054]), CerealObject), 'Can': ((0.1, -1.75, 0.8600000000000001), np.array([-0.97288474,  0.        ,  0.        ,  0.23129049]), CanObject), 'iPhone12ProMax': ((0.1, -1.75, 0.8600000000000001), np.array([0.1894379, 0.       , 0.       , 0.9818927]), iPhone12ProMaxObject)}
		
		self.placement_initializer = SequentialCompositeSampler(name="ObjectSampler")

		# can sample anywhere in bin
		bin_x_half = 0
		bin_y_half = -1.5 + t/333.333333
		pos = (bin_x_half,bin_y_half,0)
		quat = np.array([0.1894379, 0.       , 0.       , 0.9818927])
		# self.placement_initializer = UniformRandomSampler(name="ObjectSampler",mujoco_objects=self.objects,ensure_valid_placement=False,)
		self.placement_initializer.append_sampler(
			sampler=UniformRandomSampler(
				name="CollisionObjectSampler",
				mujoco_objects=self.objects,
		...
		self.placement_initializer.sample(fixtures)
		self.placement_initializer.hide(fixtures)
		# for obj in self.objects:
		# 	print("pos", pos)
		# 	if obj.name == 'iPhone12ProMax':
		# 		print("obj", obj.name)
		# 		fixtures[obj.name] = (pos,quat,obj)
		...
		print("bin_x_half in placement_initialize", bin_x_half)
		print("bin_y_half", bin_y_half)
		# each visual object should just be at the center of each target bin
		# index = 0
		# for vis_obj in self.visual_objects:
