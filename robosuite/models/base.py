...
class MujocoXML(object):
    ...
    def resolve_asset_dependency(self):
        ...
        """
        #print("resolve_asset_dependency() base.py models")
    ...
    def create_default_element(self, name):
        ...
        """
        #print("create_default_element() base.py models")
    ...
    def get_model(self, mode="mujoco_py"):
        ...
        """
        #print("get_model() base.py models")
        ...
        with io.StringIO() as string:
            ...
            if mode == "mujoco_py":
                ...
                sim = MjSim(model)
                #print("joint pose in base.py models",sim.data.get_joint_qpos("robot0_branch2_joint"))
                return model
            raise ValueError(
    ...
    def save_model(self, fname, pretty=False):
        ...
        """
        #print("save_model() base.py models")
    ...
    def merge_assets(self, other):
        ...
        """
        #print("merge_assets() base.py models")
    ...
    def get_element_names(self, root, element_type):
        ...
        """
        #print("get_element_names() base.py models")
        names = []
        for child in root:
    ...
    def _get_default_classes(default):
        ...
        #print("_get_default_classes() base.py models")
        default_dic = {}
    ...
    def _replace_defaults_inline(self, default_dic, root=None):
        ...
        #print("_replace_defaults_inline() base.py models")
        if root is None:
            root = self.root
...
class MujocoModel(object):
    ...
    def correct_naming(self, names):
        ...
        """
        #print("correct_naming() base.py models")
    ...
    def set_sites_visibility(self, sim, visible):
        ...
        #print("set_sites_visibility() base.py models")
...
class MujocoXMLModel(MujocoXML, MujocoModel):
    ...
    def __init__(self, fname, idn=0):
        #print("init() base.py MujocoXMLModel class in models")
