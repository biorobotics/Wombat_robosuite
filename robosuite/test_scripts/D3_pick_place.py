...
class D3_pick_place_env(object):
	...
	def set_env(self):
		...
		self.iphonebox = BoxObject(name="iphonebox",size=[0.035,0.07,0.02],rgba=[0,0,0,1],friction=[1,1,1]).get_obj()
		self.iphonebox.set('pos', '0.6 -1.5 1')
	...
	def step(self,action):
		...
		# self.sim.data.set_joint_qvel('iphonebox_joint0', [0, 0.16, 0, 0, 0, 0])
	...
	def get_observation(self):
		...
		observation[19:26] = self.sim.data.sensordata[22:29]	#gripper base link pose
		...
		# observation[27] = self.sim.data.get_joint_qpos('box_joint0')
