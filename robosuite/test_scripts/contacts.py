...
PATH_TO_ARM_XML = os.path.expanduser('/home/yashraghav/robosuite/robosuite/models/assets/robots/wombat_arm/wombat_arm.xml')

# Load the model and make a simulator
model = mujoco_py.load_model_from_path(PATH_TO_ARM_XML)
